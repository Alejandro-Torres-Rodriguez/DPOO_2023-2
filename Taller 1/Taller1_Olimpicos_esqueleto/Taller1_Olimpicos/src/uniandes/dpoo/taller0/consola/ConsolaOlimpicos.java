...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país que representa un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}

	/**
	 * Le muestra al usuario que pais representa el atleta
	 */
	private void ejecutarAtletaPais()
	{
		System.out.println("\n Pais al que representa un atleta: \n");
		
		String atleta = input("Ingrese el nombre del atleta que desea consultar.");
		Pais resultado = calculadora.buscarAtletaPais(atleta);
		if (resultado != null)
		{
			System.out.println("El pais al que representa el atleta es: " + resultado.darNombre());
		}
		else
		{
			System.out.println("El atleta que desea consultar no se encuentra en la  base de datos.");
		}
